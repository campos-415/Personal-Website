      ...
      <div className="max-w-[1240px] w-full mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="">
            ...
            experience. The website is built using TypeScript, which has helped
            to catch any errors before the production stage. 
            ReactJS and NextJS
            have been used to create an optimized and fast website, while
            TailwindCSS has been employed to create an appealing and modern
            design. I have also integrated Firebase, ModalUI, and Recoil to
            enhance the functionality and interactivity of the website. To
            display movie information, I have implemented TMDB API, which
            provides comprehensive and up-to-date details on movies. One of the
            standout features of the website is its modals, which allow users to
            view movie trailers. Additionally, I have included a search feature,
            which enables users to easily find their desired movie from our
            extensive collection. The website has been deployed on Vercel,
            ensuring reliable and efficient access for all users. Overall, the
            website provides a seamless and enjoyable experience for movie
            lovers, making it the perfect platform for discovering and streaming
            movies.
          </p>
